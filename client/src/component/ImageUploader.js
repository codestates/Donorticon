...
const ImageUploader = ( {includeMessage=false, handleModalOpen, api, giverId, helperId, roomId}) => {
  ...
  const handleSubmit = async () => {
    const url = await (await axios.post(api, {message, giverId, helperId, roomId})).data.url;
